...
- Развернут k8s в yc
- Установлен и настроен Helm2 + Tiller
- Установлен Helm3
- Добавлен Ingress
- Поднят Gitlab
- Создал Helm chart для приложения, и каждой компоненты отдельно
- Поиграл и настроил пайплайны по заданию
- Деплой приложения на stage и production после выкатки в мастер
